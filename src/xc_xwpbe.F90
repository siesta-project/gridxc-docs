...
!--------------------------------------------------------------
! shanghui edit for siesta case (2010.04.01)
! *****************************************************************************
MODULE gridxc_xwpbe
...
! *** Global parameters ***
  ...
  REAL(KIND=dp), PARAMETER :: rootpi = 1.77245385090551602729816748_dp
  ...
  real(dp),parameter:: sx=-0.250d0, sx0=1.0d0, omega=0.110d0, &
                       epsilon_rho=EPSILON(0.0_dp), epsilon_norm_drho= EPSILON(0.0_dp) 
   !hse : sx=-0.250d0, sx0=1.0d0, omega=0.110d0
  CHARACTER(len=*), PARAMETER, PRIVATE :: moduleN = 'xc_xwpbe'

  CONTAINS

   subroutine xwpbe( nspin, Dens, GDens,   &
                     EX, DEXDD, DEXDGD )
   implicit none

   !input and output
   INTEGER           nspin,ispin
   real(dp)          Dens(nspin),GDens(3,nspin),EX,  &
                     DEXDD(nspin),DEXDGD(3,nspin) 
   
   !internal 
   
   real(dp)  rho,norm_drho,e_0,e_rho,e_ndrho, &
   ...
   if(nspin.eq.1) then 
   rho=Dens(nspin)
   norm_drho = SQRT( GDens(1,nspin)**2  + GDens(2,nspin)**2  + GDens(3,nspin)**2  ) 
   call xwpbe_lda_calc( order, rho, norm_drho, e_0, e_rho, e_ndrho,&
                            e_rho_rho, e_ndrho_rho, e_ndrho_ndrho,&
                            epsilon_rho, epsilon_norm_drho, sx, sx0, omega)
    EX=e_0
    DEXDD(nspin)=e_rho
    DEXDGD(1:3,nspin)=e_ndrho*GDens(1:3,nspin)/norm_drho
    !write(6,*) 'spin1:',rho,DEXDD(1)   
   else
   
      do ispin=1,nspin
   !e_0=0.0d0 e_0 need to be added to get the right Exc
   e_rho=0.0d0
   e_ndrho=0.0d0 
   e_rho_rho=0.0d0 
   e_ndrho_rho=0.0d0
   e_ndrho_ndrho=0.0d0
   rho=Dens(ispin)
   norm_drho = SQRT( GDens(1,ispin)**2  + GDens(2,ispin)**2  + GDens(3,ispin)**2  ) 
   call xwpbe_lsd_calc( order, rho, norm_drho, e_0, e_rho, e_ndrho,&
                            e_rho_rho, e_ndrho_rho, e_ndrho_ndrho,&
                            epsilon_rho, epsilon_norm_drho, sx, sx0, omega)
    EX=e_0
    DEXDD(ispin)=e_rho
    DEXDGD(1:3,ispin)=e_ndrho*GDens(1:3,ispin)/norm_drho
      enddo
      !write(6,*) 'spin2:',Dens(1),DEXDD(1)   
!    do ispin=1,nspin
!  e_rho=0.0d0
!  e_ndrho=0.0d0
!  e_rho_rho=0.0d0
...
!    DEXDD(ispin)=e_rho
! ================||bug||============================
!    DEXDGD(ispin,1:3)=e_ndrho*GDens(1:3,nspin)/norm_drho
! ================||bug||============================
!    write(6,*) 'xwpbe:',ispin,e_rho,DEXDD(ispin),DEXDD(1)
!    enddo
   endif 
   end subroutine xwpbe
...
! *****************************************************************************
  SUBROUTINE xwpbe_lda_calc( order, rho, norm_drho, e_0, e_rho, e_ndrho,&
                            e_rho_rho, e_ndrho_rho, e_ndrho_ndrho,&
                            epsilon_rho, epsilon_norm_drho, sx, sx0, omega)
    ...
    !DO ip =1,1
      my_rho = MAX(rho,0.0_dp)
      IF(my_rho > epsilon_rho) THEN
        my_ndrho = MAX(norm_drho,0.0_dp)
        ...
        IF(sx0/=0.0_dp) THEN
          !original PBE hole
           IF(ss*sscale>gcutoff) THEN
             CALL xwpbe_lda_calc_0(e_0, e_rho, e_ndrho, e_rho_rho,&
                                   e_ndrho_rho, e_ndrho_ndrho, my_rho,&
                                   my_ndrho, sscale, sx0, order)
           ELSE
             CALL xwpbe_lda_calc_01(e_0, e_rho, e_ndrho, e_rho_rho,&
                                   e_ndrho_rho, e_ndrho_ndrho, my_rho,&
                                   my_ndrho, sscale, sx0, order)
           END IF
        END IF
        ...
        IF( sx /= 0.0_dp ) THEN
          IF(ww<wcutoff .AND. ss*sscale>gcutoff) THEN
            CALL xwpbe_lda_calc_1(e_0, e_rho, e_ndrho, e_rho_rho,&
                                  e_ndrho_rho, e_ndrho_ndrho, my_rho,&
                                  my_ndrho, omega, sscale, sx, order)
          ELSE IF(ww<wcutoff .AND. ss*sscale<=gcutoff) THEN
            CALL xwpbe_lda_calc_2(e_0, e_rho, e_ndrho, e_rho_rho, &
                                  e_ndrho_rho, e_ndrho_ndrho,my_rho,&
                                  my_ndrho, omega, sscale, sx, order)
          ELSE IF(ww>=wcutoff .AND. ss*sscale>gcutoff) THEN
            CALL xwpbe_lda_calc_3(e_0, e_rho, e_ndrho, e_rho_rho,&
                                  e_ndrho_rho, e_ndrho_ndrho, my_rho,&
                                  my_ndrho, omega, sscale, sx, order)
          ELSE
            CALL xwpbe_lda_calc_4(e_0, e_rho, e_ndrho, e_rho_rho,& 
                                  e_ndrho_rho, e_ndrho_ndrho, my_rho,&
                                  my_ndrho, omega, sscale, sx, order)
          END IF
        END IF
...
! *****************************************************************************
  SUBROUTINE xwpbe_lda_calc_0(e_0, e_rho, e_ndrho, e_rho_rho, e_ndrho_rho, &
    ...
    REAL(KIND=dp) :: d2Qndrhondrho, d2Qrhondrho, d2Qrhorho, dQndrho, dQrho, &
      Q, t1, t10, t100, t1003, t1007, t1018, t1023, t1024, t103, t1037, t105, &
      t1055, t1056, t1057, t1059, t106, t1060, t1073, t1079, t1082, t109, &
      t11, t110, t1100, t111, t1110, t1114, t1117, t112, t114, t1143, t116, &
      t1165, t117, t118, t119, t12, t120, t1202, t121, t1215, t122, t123, &
      t1242, t125, t1258, t126, t1263, t127, t1286, t13, t130, t1316, t134, &
      t1347, t135, t1352, t1358, t136, t1362, t1365, t1369, t1372, t138, &
      t1382, t1388, t139, t1392, t1395, t14, t1412, t142, t143, t145, t1455, &
      t146, t1465, t147, t148, t149, t15, t150, t1510, t152, t1547
    REAL(KIND=dp) :: t156, t1561, t158, t159, t16, t160, t163, t164, t165, &
      t166, t169, t170, t172, t173, t174, t175, t176, t18, t180, t183, t184, &
      t185, t187, t188, t19, t190, t191, t192, t193, t199, t2, t20, t200, &
      t201, t202, t203, t207, t209, t21, t215, t218, t219, t22, t220, t222, &
      t223, t224, t225, t227, t228, t231, t233, t236, t237, t24, t240, t241, &
      t242, t245, t246, t247, t249, t25, t250, t253, t254, t258, t26, t261, &
      t262, t263, t265, t266, t269, t272, t274, t275, t278, t28, t281, t282, &
      t284, t285, t287, t288, t29, t290, t291, t294, t297, t3, t300, t301, &
      t303, t304, t306, t307, t31, t314, t32, t321, t323, t326
    REAL(KIND=dp) :: t327, t33, t330, t334, t335, t336, t337, t338, t339, &
      t34, t340, t342, t343, t344, t345, t347, t355, t356, t357, t358, t359, &
      t36, t361, t362, t363, t367, t368, t37, t372, t374, t376, t377, t381, &
      t383, t384, t387, t388, t39, t390, t391, t394, t397, t398, t4, t40, &
      t400, t401, t402, t404, t405, t406, t408, t409, t410, t411, t412, t413, &
      t414, t415, t416, t417, t418, t42, t423, t425, t426, t429, t430, t432, &
      t433, t435, t44, t440, t443, t444, t446, t447, t449, t46, t463, t465, &
      t47, t471, t472, t475, t476, t478, t479, t480, t484, t485, t489, t491, &
      t495, t497, t5, t500, t501, t504, t505, t507, t508, t510
    REAL(KIND=dp) :: t511, t513, t514, t515, t52, t520, t53, t530, t537, t54, &
      t421, t422, t423, t426, t427, t428, t431, t433, t434, t435, t437, t438, &
      t439, t44, t443, t444, t450, t453, t454, t456, t457, t459
    REAL(KIND=dp) :: t46, t464, t465, t468, t469, t472, t473, t475, t476, &
      t477, t478, t48, t484, t486, t487, t49, t498, t5, t500, t501, t505, &
      t510, t513, t519, t522, t526, t530, t533, t536, t539, t54, t540, t544, &
      t545, t548, t55, t553, t555, t557, t558, t56, t561, t563, t564, t568, &
      t569, t572, t575, t576, t578, t579, t58, t581, t584, t588, t594, t597, &
      t599, t6, t60, t603, t607, t61, t610, t613, t616, t618, t619, t620, &
      t623, t63, t632, t65, t655, t657, t662, t664, t667, t67, t68, t69, &
      t694, t7, t70, t700, t706, t71, t72, t723, t726, t728, t73, t74, t744, &
      t75, t751, t752, t769, t77, t772, t774, t78, t782, t783, t784
    REAL(KIND=dp) :: t789, t792, t793, t794, t795, t799, t8, t80, t803, t804, &
      t807, t81, t811, t812, t819, t82, t83, t84, t848, t85, t852, t862, &
      t863, t864, t865, t868, t87, t872, t878, t879, t88, t880, t9, t90, t91, &
      t916, t92, t920, t93, t930, t931, t932, t935, t939, t94, t943, t95, &
      t956, t96, t961, t966, t97, t972, t985, t99, t990, t995
...
!> \author Manuel Guidon
! *****************************************************************************
  SUBROUTINE xwpbe_lsd_calc( order, rho, norm_drho, e_0, e_rho, e_ndrho, &
                            e_rho_rho, e_ndrho_rho, e_ndrho_ndrho, &
                            epsilon_rho, epsilon_norm_drho,sx, sx0, omega)
    INTEGER, INTENT(in)                      ::  order
    REAL(kind=dp), &
    ...
    !DO ip =1,npoints
      ...
      my_rho = 2.0_dp*MAX(rho,0.0_dp)
      IF(my_rho > epsilon_rho) THEN
        my_ndrho = 2.0_dp*MAX(norm_drho,0.0_dp)
        ...
        IF(sx0/=0.0_dp) THEN
          !original PBE hole
           IF(ss*sscale>gcutoff) THEN
             CALL xwpbe_lda_calc_0(e_0_temp, e_rho, e_ndrho, e_rho_rho,&
                                   e_ndrho_rho, e_ndrho_ndrho, my_rho,&
                                   my_ndrho, sscale, sx0, order)
           ELSE
             CALL xwpbe_lda_calc_01(e_0_temp, e_rho, e_ndrho, e_rho_rho,&
                                   e_ndrho_rho, e_ndrho_ndrho, my_rho,&
                                   my_ndrho, sscale, sx0, order)
           END IF
           !According to spin-scaling relation, we need only half of the energy
           e_0 = e_0 + 0.5_dp * e_0_temp
        END IF
        e_0_temp = 0.0_dp
        IF(sx/=0.0_dp) THEN
          IF(ww<wcutoff .AND. ss*sscale>gcutoff) THEN
            CALL xwpbe_lda_calc_1(e_0_temp, e_rho, e_ndrho, e_rho_rho,&
                                  e_ndrho_rho, e_ndrho_ndrho, my_rho,&
                                  my_ndrho, omega, sscale, sx, order)
          ELSE IF(ww<wcutoff .AND. ss*sscale<=gcutoff) THEN
            CALL xwpbe_lda_calc_2(e_0_temp, e_rho, e_ndrho, e_rho_rho, &
                                  e_ndrho_rho, e_ndrho_ndrho,my_rho,&
                                  my_ndrho, omega, sscale, sx, order)
          ELSE IF(ww>=wcutoff .AND. ss*sscale>gcutoff) THEN
            CALL xwpbe_lda_calc_3(e_0_temp, e_rho, e_ndrho, e_rho_rho,&
                                  e_ndrho_rho, e_ndrho_ndrho, my_rho,&
                                  my_ndrho, omega, sscale, sx, order)
          ELSE
            CALL xwpbe_lda_calc_4(e_0_temp, e_rho, e_ndrho, e_rho_rho,& 
                                  e_ndrho_rho, e_ndrho_ndrho, my_rho,&
                                  my_ndrho, omega, sscale, sx, order)
          END IF
         !According to spin-scaling relation, we need only half of the energy
